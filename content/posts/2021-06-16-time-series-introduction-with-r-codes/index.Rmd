...
knitr::opts_chunk$set(echo = TRUE,
                      fig.show = "hold",
                      fig.align = "center", dpi = 100, collapse = TRUE)
...
For this article I'll first load the `MASS` package that contains some of the dataset we will use.
We can list all datasets available with the function `data()` from package `utils`.
