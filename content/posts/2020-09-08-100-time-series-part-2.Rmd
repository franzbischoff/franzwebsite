...
Again the `tsmp` does all for you. First I'll demonstrate how to work with that step by step, and after, using the [MPA](https://matrixprofile.org/) (Matrix Profile API), introduced by the [MPA](https://matrixprofile.org/) (Matrix Profile Foundation) has standard functions to use in `R` and other languages.
